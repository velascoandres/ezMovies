...
import com.example.andres.ezmoviesadmin.dummy.CategoriaContent

/**
 * A fragment representing a list of Items.
 * Activities containing this fragment MUST implement the
 * [CategoriaFragment.OnListFragmentInteractionListener] interface.
 */
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyCategoriaRecyclerViewAdapter(CategoriaContent.ITEMS, listener,this.context)
            }
        }
        return view
    }
